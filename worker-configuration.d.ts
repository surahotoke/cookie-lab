/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4ec8b66bf2ee7da40dd53887de454ffd)
// Runtime types generated with workerd@1.20260611.1 2026-06-07 nodejs_compat
interface __BaseEnv_Env {
	KV: KVNamespace;
	DB: D1Database;
	TOTAL: DurableObjectNamespace<import("./src/index").Total>;
	PRESENCE: DurableObjectNamespace<import("./src/index").Presence>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Total" | "Presence";
	}
	interface ProdEnv {
		KV: KVNamespace;
		DB: D1Database;
